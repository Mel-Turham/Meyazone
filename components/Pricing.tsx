...
const Pricing = () => {
	return (
		<section className='py-10 container sm:py-16 lg:py-8'>
			<div className='px-4 '>
				...
				<div className='hidden mt-16 lg:block'>
					<table className='w-full'>
						<thead>
							<tr>
								...
								<th className='px-4 py-8 text-center bg-gray-900 rounded-t-xl'>
									<span className='px-4 py-2 text-base font-medium  bg-myprimary rounded-full'>
										{' '}
										Popular{' '}
									</span>
						...
						<tbody>
							<tr>
								<td className='py-4 pr-4 font-medium border-b dark:border-slate-800 border-gray-200'>
									Website number
								</td>

								<td className='px-4 py-4 text-center border-b dark:border-slate-800 border-gray-200'>
									01
								</td>
							...
							<tr>
								<td className='py-4 pr-4 font-medium border-b border-gray-200 dark:border-slate-800'>
									Unmetered Bandwidth
								</td>

								<td className='px-4 py-4 text-center border-b border-gray-200 dark:border-slate-800'>
									-
								</td>
			...
			<div className='block container mt-12 border-t border-b dark:border-slate-800 border-gray-200 divide-y divide-gray-200 lg:hidden'>
				...
				<div className='grid grid-cols-4 text-center divide-x divide-gray-200'>
					...
					<div className='px-1 py-2 sm:px-4'>
						<span className='text-sm font-medium bg-myprimary'> Popular </span>
						<p className='mt-2 text-xl font-bold'>$150</p>
						<span className='mt-1 text-sm font-normal text-gray-500'>
							{' '}
							Per month{' '}
