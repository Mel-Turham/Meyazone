						...
						<div className='space-y-5 pt-5 '>
							...
							<div className='divide-y'>
								{Array.from({ length: 2 }, (_, index) => (
									<div className='flex gap-6 py-8' key={index}>
										{/* image */}
										<Image
											src={'/user-3.jpg'}
											alt=''
											...
											width={200}
											height={200}
											className='w-24 h-24 object-contain bg-red-300 rounded'
										/>
										{/* comment contains */}
										<div className=' flex flex-col gap-5 w-full'>
											<div className='flex justify-between'>
												...
												<Button size={'sm'} className='rounded font-semibold'>
													Reply
												</Button>
											</div>
											<p className='text-sm text-pretty font-serif leading-[1.6rem]'>
												Lorem ipsum dolor, sit amet consectetur adipisicing
												elit. Quo voluptas magnam nihil unde dolor qui sapiente
												sint ab amet asperiores aut dolores obcaecati similique
												quos necessitatibus, hic, soluta eius ad itaque aliquid
												reiciendis! Rerum autem repellat necessitatibus quia
												cupiditate accusantium pariatur atque magnam libero
												officia provident nulla facere a, natus cumque vero
											</p>
										</div>
									</div>
								))}
